...
In OTTR, we try to minimize maintenance pains. To get around this, we use `ottrpal::borrow_chapter()` from the [jhudsl/ottrpal](https://jhudatascience.org/ottrpal/) package.
