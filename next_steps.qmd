...
<pre>bookdown::gitbook:
  config:
    sharing:
      ...
      twitter: false
      all: []</pre>
<p>Then add a direct link to your form in <code>index.qmd</code>, <code>index.Rmd</code>, or your course footer. For automated responses, <a href="https://zapier.com">Zapier</a> can connect Google Form submissions to email notifications, Slack alerts, or GitHub issues.</p>'
  ),
  list(
