...
GitHub Actions will automatically run a spell check on all qmds/Rmds and mds whenever a pull request to the `main` branch is filed.
...
The `styler` package will style R code in all qmds/Rmds. Style changes are automatically committed back to your branch.
