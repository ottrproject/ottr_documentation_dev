...
(function () {
    ...
    options: [
      {
        ...
        next: {
          ...
          options: [
            { label: "Yes", result: "ottr_web" },
            { label: "No I'm starting fresh", result: "ottr_quarto_web" }
          ]
        }
      },
      {
        ...
        next: {
          ...
          options: [
            { label: "Yes", result: "ottr_courses" },
            { label: "No I'm starting fresh", result: "ottr_quarto_courses" }
          ]
        }
      },
      {
        label: "Metrics Dashboard",
        result: "ottr_metricminer_dashboard"
      }
    ]
  };
  ...
  const results = {
    ...
    ottr_courses: {
      ...
      url: "getting_started.html#ottr-courses",
      recommended: false
    },
    ottr_quarto_courses: {
      name: "OTTR Quarto Courses",
      description: "A Quarto-based course template. Recommended for new projects.",
      url: "getting_started.html#ottr-quarto-courses",
      recommended: true,
      fallback: "ottr_courses"
    },
    ottr_metricminer_dashboard: {
      name: "OTTR Metricminer Dashboard",
      description: "Collect and display metrics from GitHub, Google Analytics, Google Forms, CRAN, Calendly, and more.",
      url: "getting_started.html#ottr-metricminer-dashboard",
      recommended: false
    }
  };
