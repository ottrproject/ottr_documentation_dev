...
<div style="text-align: center; margin: 0.5rem 0 1.5rem;">
  <a href="choose_template.html" style="display: inline-block; background-color: #f0fafd; color: #2a7a9a; border: 1.5px solid #ADD8E6; border-radius: 20px; padding: 7px 20px; font-size: 0.9rem; font-weight: 600; text-decoration: none;">
...
Work in GitHub without installing a local publishing toolchain.
:::
...
::: {.ottr-feature-image}
![OTTR helps build GitHub-based websites with less hassle. Catch potential mistakes before they go live.](./resources/images/why-ottr.png)
:::
:::
...
:::
::: {.benefit-title}
Publish with Quarto or bookdown
:::
::: {.benefit-copy}
Create websites using [Quarto](https://quarto.org/) or [bookdown](https://bookdown.org/), depending on the content format your project needs.
:::
:::
...
:::
::: {.benefit-title}
Format once, update everywhere
:::
::: {.benefit-copy}
Prepare courses for learning platforms like [Coursera](https://www.coursera.org/) and [Leanpub](https://leanpub.com/) while keeping updates easier to manage.
:::
:::
...
:::
::: {.benefit-title}
Gather metrics in one place
:::
::: {.benefit-copy}
Pull metrics from a variety of sources into dashboards that help you understand how your materials are being used.
:::
:::
:::
