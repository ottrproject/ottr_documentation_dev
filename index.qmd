...
<style>
  ...
  .overview-layout .ottr-feature-section {
    grid-template-columns: 1fr;
    gap: 1rem;
    margin: 1rem 0 0;
  }
  .overview-layout .benefit-grid {
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 1rem 1.25rem;
  }
	  .overview-layout .benefit-item {
	    min-height: 0;
	  }
	  .overview-layout .ottr-feature-image img {
	    width: min(100%, 220px);
	  }
	  .overview-layout .ottr-glance {
	    grid-template-columns: 1fr;
	    margin-top: 0.75rem;
	  }
	  .overview-layout .glance-step {
	    min-height: 0;
	  }
	  .overview-layout .glance-link {
	    margin-bottom: 0;
	  }
