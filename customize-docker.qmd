...
There's a library of ottr-ready docker images that you can see in [ottrproject/ottr-docker](https://github.com/ottrproject/ottr-docker). If you would like to contribute your own customized docker image that works with OTTR, please file a pull request!
