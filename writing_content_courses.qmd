...
Add the new filename to `_quarto.yml` under `chapters:`:
...
book:
  title: "Course Name"
  repo-url: https://github.com/ottrproject/OTTR_Template/
  chapters:
    - index.qmd
    - 01-intro.qmd
    - 02-chapter_of_course.qmd
    - 03-new_chapter_of_course.qmd  ## Only this is new!
    - about.qmd
output-dir: docs
```
...
repo: https://github.com/ottrproject/OTTR_Template/
rmd_files: ["index.Rmd",
            "01-intro.Rmd",
