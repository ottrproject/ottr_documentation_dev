...
document.addEventListener("DOMContentLoaded", function () {
  const tabMap = {
    "#ottr-courses":               "tabset-1-1-tab",
    "#ottr-quarto-courses":        "tabset-1-2-tab",
    "#ottr-web":                   "tabset-1-3-tab",
    "#ottr-quarto-web":            "tabset-1-4-tab",
    "#ottr-metricminer-dashboard": "tabset-1-5-tab"
  };
...
Select the OTTR flavor you are using to access setup instructions.

::: {.panel-tabset group="ottrType"}

## OTTR Courses

<span id="ottr-courses"></span>

**Template repository:** [ottrproject/OTTR_Template](https://github.com/ottrproject/OTTR_Template)

An R Markdown / Bookdown-based course template with a table of contents on the side. Supports publishing to Coursera and Leanpub.
...
### 8. Enroll for OTTR updates (recommended)

The OTTR templates are always a work in progress. When updates are made to non-content files (checks, automation), pull requests are automatically filed to downstream repositories.
...
<span id="ottr-quarto-courses"></span>
...
<span id="ottr-metricminer-dashboard"></span>
