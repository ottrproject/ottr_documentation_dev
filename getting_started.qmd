...
**Template repository:** [ottrproject/OTTR_Quarto_Website](https://github.com/ottrproject/OTTR_Quarto_Website)
...
Edit the template's `.Rmd` files to configure which metrics to display and how to arrange them. If you adapt the dashboard into a Quarto site, use `.qmd` files with the same project-specific metric code. See [metricminer.org](https://www.metricminer.org/) for full documentation.
