...
<div style="margin: 0.5rem 0 1.5rem;">
  <a href="https://ottrproject.org/cheatsheets/ottr_quarto_course.html" style="display: inline-block; background-color: #f0fafd; color: #2a7a9a; border: 1.5px solid #ADD8E6; border-radius: 20px; padding: 7px 20px; font-size: 0.9rem; font-weight: 600; text-decoration: none;" target="_blank">
    Cheatsheet
  </a>
</div>
...
<div style="margin: 0.5rem 0 1.5rem;">
  <a href="https://ottrproject.org/cheatsheets/ottr_course.html" style="display: inline-block; background-color: #f0fafd; color: #2a7a9a; border: 1.5px solid #ADD8E6; border-radius: 20px; padding: 7px 20px; font-size: 0.9rem; font-weight: 600; text-decoration: none;" target="_blank">
    Cheatsheet
  </a>
</div>
...
<div style="margin: 0.5rem 0 1.5rem;">
  <a href="https://ottrproject.org/cheatsheets/ottr_quarto_website.html" style="display: inline-block; background-color: #f0fafd; color: #2a7a9a; border: 1.5px solid #ADD8E6; border-radius: 20px; padding: 7px 20px; font-size: 0.9rem; font-weight: 600; text-decoration: none;" target="_blank">
    Cheatsheet
  </a>
</div>
...
<div style="margin: 0.5rem 0 1.5rem;">
  <a href="https://ottrproject.org/cheatsheets/ottr_website.html" style="display: inline-block; background-color: #f0fafd; color: #2a7a9a; border: 1.5px solid #ADD8E6; border-radius: 20px; padding: 7px 20px; font-size: 0.9rem; font-weight: 600; text-decoration: none;" target="_blank">
    Cheatsheet
  </a>
</div>

An R Markdown / Bookdown-based website template with a nav bar on top. Best choice if you have existing `.Rmd` files to build on.
