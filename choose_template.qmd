...
:::
::: {.benefit-copy}
Choose a website template for documentation sites, resource hubs, or other materials that need flexible page organization. Use [Quarto](https://quarto.org/) for new projects, or R Markdown/bookdown if you already have `.Rmd` files.
:::
:::
...
:::
::: {.benefit-copy}
Choose a course template when you need a sidebar table of contents, chapter-by-chapter navigation, and optional publishing to [Coursera](https://www.coursera.org/) or [Leanpub](https://leanpub.com/). Use Quarto for new courses, or R Markdown for existing `.Rmd` course files.
:::
:::
