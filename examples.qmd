...
<div class="gallery-card">
  ...
  <div class="gallery-card-links">
    <a class="gallery-link" href="https://jhudatascience.org/Baltimore_Community_Course/" target="_blank">View course</a>
  </div>
</div>
...
<div class="gallery-card">
  <span class="badge badge-template">Template</span>
  <p class="gallery-card-title">OTTR Quarto</p>
  <p class="gallery-card-desc">The Quarto-based OTTR template for building courses and websites using <code>.qmd</code> files. Recommended for all new projects.</p>
  <div class="gallery-card-links">
    <a class="gallery-link" href="https://github.com/ottrproject/OTTR_Quarto" target="_blank">GitHub</a>
  </div>
</div>

<div class="gallery-card">
  <span class="badge badge-dashboard">Dashboard</span>
  <p class="gallery-card-title">Metricminer Dashboard</p>
  <p class="gallery-card-desc">A dashboard template powered by the <a href="https://www.metricminer.org/" target="_blank">metricminer</a> R package. Tracks GitHub, Google Analytics, Google Forms, CRAN, Calendly, and more.</p>
  <div class="gallery-card-links">
    <a class="gallery-link" href="https://github.com/ottrproject/metricminer-dashboard" target="_blank">GitHub</a>
    <a class="gallery-link" href="https://www.metricminer.org/" target="_blank">metricminer.org</a>
  </div>
</div>
