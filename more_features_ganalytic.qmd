...
---
  ...
  <a href="https://ottrproject.org/cheatsheets/google_analytics.html" target="_blank" style="font-size: 1rem; color: #2a7a9a;">↗ Open in new tab</a>
  </div>
  
<div style="margin: 1.5rem 0;">
  <iframe 
    src="https://ottrproject.org/cheatsheets/google_analytics.html"
    width="100%" 
    height="2960px" 
    style="border: 1.5px solid #ADD8E6; border-radius: 8px;"
    title="OTTR Google Analytics Cheatsheet">
  </iframe>
